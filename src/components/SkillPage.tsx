...
export default function SkillPage({ skillData }: SkillPageProps) {
  ...
  return (
    <div className="skill-page">
      ...
      <div className="skill-console" role="complementary" aria-label="Skill control unit">
        <a
          href={skillData.githubUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="skill-console__module"
          aria-label={`Execute ACTION: View ${skillData.name} source on GitHub`}
        >
          ...
          <div className="module__body">
            <GithubIcon />
            <span className="module__label">OPEN SKILL.MD</span>
          </div>
        </a>

        <a
          href={skillData.downloadUrl}
          download={`${skillData.id}.zip`}
          className="skill-console__module"
          aria-label={`Execute ACTION: Download ${skillData.name} as ZIP`}
        >
          <div className="module__header">
            <div className="module__led"></div>
          </div>
          <div className="module__body">
            <DownloadIcon />
            <span className="module__label">DOWNLOAD (.ZIP)</span>
          </div>
        </a>
      </div>
